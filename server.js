...
class PlaywrightAutomation {
  ...
  async setupBrowser(extensionPath = "/chrome-extension", headless = true, enableVnc = true) {
    try {
      ...
      // Se não for headless, configurar display para VNC
      if (!headless) {
        browserArgs.push('--display=:1', '--disable-gpu');
      }
